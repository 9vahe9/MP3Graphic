    ...
    //, ui(new Ui::MainWindow)
{
    ...
    slider_x->setGeometry(150, 500, 450, 50);


    slider_y->setGeometry(100, 50, 50, 450);


    media_x->setAudioOutput(audio_x);
    media_y->setAudioOutput(audio_y);

    media_x->setSource(QUrl("/Users/vahe/Qt_Projects/GraphicWithSerial/Songs/gucci.mp3"));
    media_y->setSource(QUrl("/Users/vahe/Qt_Projects/GraphicWithSerial/Songs/noguidance.mp3"));
...
{   
    ...
    new_label->setGeometry(x / x_val_1px + 160, 482 - y / y_val_1px, 3, 3);
